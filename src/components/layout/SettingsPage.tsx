			...
			<div className="mx-auto w-full max-w-4xl space-y-6">
				<div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-surface)] p-6 shadow-sm">
					...
					<div className="mt-6 flex items-center justify-between rounded-2xl border border-[var(--border)] bg-[var(--bg-surface-alt)] p-4">
						...
						<button
							...
							className="flex items-center gap-2 rounded-xl border border-[var(--border)] bg-[#1E1E1E] px-3 py-2 text-sm font-medium text-white transition hover:opacity-90"
				...
				<div className="rounded-3xl border border-[var(--border)] bg-[var(--bg-surface)] p-6 shadow-sm">
					...
					<div className="mt-4 flex flex-wrap gap-2">
						<span className="rounded-full border border-[#2E2E2E] bg-[#1E1E1E] px-3 py-1 text-xs text-[#CCCCCC]">UI Design</span>
						<span className="rounded-full border border-[#2E2E2E] bg-[#1E1E1E] px-3 py-1 text-xs text-[#CCCCCC]">React</span>
						<span className="rounded-full border border-[#2E2E2E] bg-[#1E1E1E] px-3 py-1 text-xs text-[#CCCCCC]">Prototyping</span>
					</div>

					<div className="mt-5 border-l border-[#2A2A2A] pl-4">
						<p className="text-sm text-[var(--text-primary)]">Experience Timeline</p>
						<p className="text-xs text-[#6B6B6B]">Lead Product Designer • 2021 – Present</p>
					</div>

					<div className="mt-5">
						<button
							type="button"
							className="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-[#0D0D0D] transition hover:opacity-90"
						>
							<Download size={15} />
							Resume
						</button>
